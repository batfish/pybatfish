...
def test_notebook_no_errors(rendered_nb):
...
def test_notebook_code_output(rendered_nb):
...
def test_notebook_execution_count(rendered_nb):
...
def test_markdown_up_to_date(rendered_nb):
